...
function Pedido({ name, date, price, city, state }) {
  return (
    <div className="mb-4 border rounded-lg shadow-sm p-4 transition duration-200 cursor-pointer hover:bg-black hover:bg-opacity-15">
      <div className="mb-2 text-lg font-semibold">Assinatura: {name}</div>
      <div className="grid grid-cols-1 gap-2 mb-2 md:grid-cols-2">
        <div className="flex items-center">
          ...
          <span>Assinado em: {new Date(date).toLocaleDateString("pt-BR")}</span>
        </div>
        <div className="flex items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
